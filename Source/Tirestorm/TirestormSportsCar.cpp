...
#include "TirestormSportsCar.h"
#include "TirestormSportsWheelFront.h"
#include "TirestormSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATirestormSportsCar::ATirestormSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTirestormSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTirestormSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTirestormSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTirestormSportsWheelRear::StaticClass();
